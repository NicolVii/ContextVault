...
| Architecture changes required | **14** |
| Clarifications required | **11** |
| Stage-15 / sequencing / first-PR constraints | **17** |
| Accepted risks | **8** |
| Rejected attacks | **9** |
| Unresolved | **7** |
| True cross-stage contradictions | **9** |
| Resolvable tensions | **12** |
...
| A12 | safety | Conflicting high-trust memories | 08/12 conflict | Two trusted opposites | Dual settled facts in prompt | medium | high | moderate | high | conflict groups | Budget eviction | **confirmed_blocker** for packing claims | Normative conflict reserve | Conflict budget tests | Pack conflicts first | — |
...
| A16 | extraction | Hallucinated extraction | 04/10; heuristic L147–149 | Timeout→heuristic | Invented proposed memories | high | medium | easy | high | proposed status | Queue flood; user confirms bad | **confirmed_blocker** for current path vs target | Remove inventing fallback | Heuristic invent test | — | First PR may disable fallback only if separately specified; Stage 17 forbids broad behaviour change without spec |
...
| A26 | entities | Under-merging | 11 | Many aliases | Fragmented context | medium | low | moderate | medium | alias table | — | accepted_risk | Prefer under-merge | — | — | — |
...
| A45 | correctness | Embedding drift/upgrade | 09 spaces | Silent model upgrade | Rank chaos | high | high | moderate | high | space registry | Not implemented | **confirmed_blocker** for upgrades | Registry before model change | Drift A/B | No embed model change in early PRs | — |
...
| A54 | privacy | Embeddings leak restricted info | embed external | Embed secrets | Vector inversion risk | low | medium | difficult | low | secret block | Residual | accepted_risk | Block secrets pre-embed | — | — | — |
...
| A56 | delivery | Overbuilt architecture delays PMF | Rec B full | Build 8–12 fully | No users; wasted eng | high | high | easy | high | phased 16 | Scope creep | **confirmed_blocker** for “build all before learn” | Adopt MVA cut | — | Sequence MVA first | First PR only MVA foundation |
